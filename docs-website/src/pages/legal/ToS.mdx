...
## Free Public Assets Terms of Service

If not stated otherwise in the package files, all free public assets are licensed under the [Mozilla Public License 2.0](https://mozilla.org/MPL/2.0/).  
Currently, this applies to the Free Public version of the [Quantum Particles](/docs/particles/) package.

### Key Points:

1. **Use and Distribution**: You are free to use, modify, and distribute the assets, including for commercial purposes, as long as any files containing my code remain under the MPL 2.0 license.

2. **Source Code Availability**: If you modify the assets and distribute your modifications, you must make the source code of those modifications available under the same license.

3. **Combination with Other Code**: You may combine the assets with code under different licenses, but my assets (and any modifications) must remain under the MPL 2.0.

4. **Attribution**: You must include a copy of the MPL 2.0 license or a notice as specified in the license when distributing the assets.

5. **Credit**: I kindly ask you to provide appropriate credit by mentioning `@Quantum` and linking to this [Discord](https://discord.gg/Va5VPev) server where applicable.

6. **No Warranty**: The assets are provided "as is" without any warranty of any kind.

### You **CAN**:

1. Use the free public assets for **personal and commercial use**, including in your own avatars and worlds.

2. Modify the assets for your own use.

3. Distribute the assets and your modifications, as long as you comply with the MPL 2.0 license terms.

4. Combine the assets with other code under different licenses, provided that the files containing my code remain under the MPL 2.0.

### You **MUST**:

1. Keep any files containing my code under the MPL 2.0 license.

2. Include a copy of the MPL 2.0 license or a notice as specified in the license when distributing the assets or your modifications.

3. Make the source code of any modifications available under the same license if you distribute your modifications.

4. Provide appropriate credit by mentioning `@Quantum` and linking to this [Discord](https://discord.gg/Va5VPev) server where applicable.

### You **CANNOT**:

1. Redistribute the assets or any modifications **without complying** with the MPL 2.0 license terms.

2. Remove or alter any copyright notices or licensing information.

3. Claim the assets or any modifications as your own without proper attribution.
